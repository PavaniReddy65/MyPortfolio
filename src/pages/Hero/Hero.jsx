...
const profile = {
  name: 'Pavani Reddy',
  title: 'AI & Data Science Student | Python Developer | Backend Enthusiast',
  skills: [
    'Python', 'Django', 'Django REST Framework', 'JavaScript',
    'React', 'SQL', 'Git', 'Linux', 'Data Analysis',
    'REST APIs', 'Automation', 'Problem Solving'
  ],
  hardWorker: true,
  quickLearner: true,
  problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Python developer 🐍 | Django REST Framework enthusiast ⚡ | Passionate about backend development & automation 🤖
                </p>
              </div>

              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                <a
                  href="https://github.com/pavanireddy"
